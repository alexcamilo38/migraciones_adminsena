        ...
        <div class="row g-3 mb-5">
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card border-0 shadow-sm rounded-3 p-3 bg-white">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <span class="text-secondary small fw-bold d-block text-uppercase mb-1">Convocatorias
                                Activas</span>
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card border-0 shadow-sm rounded-3 p-3 bg-white">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <span class="text-secondary small fw-bold d-block text-uppercase mb-1">Aspirantes
                                Inscritos</span>
